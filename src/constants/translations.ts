...
export const NOT_FOUND_DESCRIPTION_TEXT = "notFound:description.text";
export const NOT_FOUND_DESCRIPTION_LINK = "notFound:description.link";

export const ANIMAL_PAGE = "animalDetail";
export const ANIMAL_TITLE = "animalDetail:title";

export const LOGIN_PAGE = "login";
export const LOGIN_MAIL_DESCRIPTION = "login:username.description";
export const LOGIN_MAIL_PLACEHOLDER = "login:username.placeholder";
